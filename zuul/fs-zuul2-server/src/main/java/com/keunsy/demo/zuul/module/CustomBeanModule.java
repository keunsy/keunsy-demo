package com.keunsy.demo.zuul.module;

import com.google.inject.AbstractModule;
import com.keunsy.demo.zuul.netty.CustomServerStartup;
...
public class CustomBeanModule extends AbstractModule {

  @Override
  protected void configure() {
    // use custom
    bind(BaseServerStartup.class).to(CustomServerStartup.class);
    ...
    bind(AccessLogPublisher.class).toInstance(new AccessLogPublisher("ACCESS", (channel, httpRequest) -> ClientRequestReceiver
